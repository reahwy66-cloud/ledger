(function(){
  ...
  var I18N={
    ar:{
      "nav.services":"الخدمات","nav.packages":"الباقات","nav.clients":"عملاؤنا","nav.contact":"تواصل معنا","nav.start":"ابدأ مشروعك",
      "hero.eyebrow":"رِواء ستوديو","hero.title":"كل ما يحتاجه مشروعك. بفريق واحد.","hero.body":"من صناعة المحتوى والتصوير، إلى الإعلانات والهوية والمواقع والتطبيقات.","hero.cta":"ابدأ مشروعك","hero.secondary":"اكتشف خدماتنا","hero.note1":"محتوى سريع ومرن","hero.note2":"تنفيذ بصري موحّد","hero.note3":"حلول من وسائل التواصل إلى الويب","hero.card1k":"CONTENT","hero.card1v":"تصوير + Reels","hero.card2k":"DESIGN","hero.card2v":"هوية + Listing","hero.card3k":"GROWTH","hero.card3v":"إعلانات + إدارة","hero.card4k":"DIGITAL","hero.card4v":"مواقع + تطبيقات",
      "services.kicker":"ما الذي نفعله","services.title":"كل ما تحتاجه علامتك، تحت سقف واحد.","services.body":"نصمّم خدماتنا وفق هدفك: حضور مستمر، أو إطلاق منتج، أو حملة، أو تجربة رقمية متكاملة.",
      "services.s1t":"إدارة وسائل التواصل الاجتماعي","services.s1b":"إعداد خطة المحتوى، والنشر، وإدارة الصفحة، والتواصل مع الجمهور.","services.s2t":"تصوير سينمائي","services.s2b":"تصوير منتجات، أشخاص ومساحات بصياغة بصرية تناسب المنصة.","services.s3t":"مونتاج Reels","services.s3b":"إيقاع، صوت، ألوان وحركة مصممة للمحتوى القصير.","services.s4t":"التصميم وصناعة المحتوى","services.s4b":"منشورات وأفكار ونصوص وحملات متناسقة مع هوية العلامة.","services.s5t":"إعلانات ممولة","services.s5b":"إعداد الحملات، المتابعة والتحسين على منصات Meta.","services.s6t":"Branding","services.s6b":"هوية بصرية ونظام تصميم قابل للتطبيق على كل نقاط التواصل.","services.s7t":"Listing Images","services.s7b":"صور متاجر احترافية توضّح المنتج ومزاياه بشكل مقنع.","services.s8t":"3D و AI Video","services.s8b":"مشاهد ثلاثية الأبعاد وفيديوهات مدعومة بالذكاء الاصطناعي.","services.s9t":"مواقع وتطبيقات ومتاجر","services.s9b":"تجارب رقمية سريعة ومتجاوبة من الفكرة حتى الإطلاق.","services.s10t":"حل مشكلات Meta","services.s10b":"دعم تقني لإعداد الحسابات والربط ومعالجة مشكلات الإعلانات.",
      "packages.kicker":"باقات الإدارة الشهرية","packages.title":"اختر حجم الحضور الذي يناسبك.","packages.body":"كل الباقات تشمل إدارة الصفحة والرد. ميزانية التمويل على Meta غير مشمولة بالسعر.","packages.p1t":"بداية ثابتة","packages.p1a":"4 Reels شهريًا","packages.p1b":"4 منشورات شهريًا","packages.p2t":"نمو مستمر","packages.p2a":"6 Reels شهريًا","packages.p2b":"6 منشورات شهريًا","packages.p3t":"حضور مكثّف","packages.p3a":"8 Reels شهريًا","packages.p3b":"8 منشورات شهريًا","packages.manage":"إدارة الصفحة والرد","packages.meta":"ميزانية إعلانات Meta غير مشمولة","packages.popular":"الأكثر توازنًا",
      "about.kicker":"من نحن","about.title":"خبرة سبقت الاسم. ورؤية بدأت عام 2026.","about.body":"رِواء ستوديو وكالة تسويق انطلقت عام 2026، مستندة إلى أكثر من عشر سنوات من الخبرة في السوقين السوري والإماراتي. نعمل بدقة واحترافية، ونحوّل الأفكار إلى حضور بصري واضح يترك أثرًا ملموسًا في حضور العلامات التجارية.","about.slogan":"ما يُروى... يُرى.","about.years":"سنوات خبرة","about.markets":"خبرة في سوقين","about.launch":"انطلاق رِواء ستوديو",
      "photo.kicker":"جلسة تصوير","photo.title":"30 صورة بجلسة مركّزة","photo.body":"30 صورة: 15 صورة معدّلة بعناية، وتُسلَّم بقية الصور بصيغة RAW.","promo.kicker":"تغطية وفيديو ترويجي","promo.title":"فيديو ترويجي لافتتاح أو فعالية","promo.body":"عدد غير محدود من الصور أثناء التغطية + 15 صورة معدّلة + فيديو ترويجي.",
      "clients.kicker":"شركاء النجاح","clients.title":"علامات نعتز بالعمل معها.","clients.body":"نستعرض هنا مجموعة من العلامات التي اخترنا مشاركتها ضمن أعمال رِواء ستوديو.","clients.loading":"جارٍ تحميل العملاء…","clients.empty":"ستظهر هنا العلامات المختارة بعد تفعيل عرضها من لوحة التحكم.","clients.visit":"زيارة الرابط",
      "process.kicker":"طريقة العمل","process.title":"منهجية واضحة منذ الخطوة الأولى.","process.s1t":"نفهم الهدف","process.s1b":"نحدد الجمهور، العرض والمنصة قبل أن نبدأ الإنتاج.","process.s2t":"نضع الخطة","process.s2b":"نحوّل الهدف إلى محتوى وتصميم وتصوير بجدول واضح.","process.s3t":"ننفّذ ونطوّر","process.s3b":"ننتج وننشر ونطوّر التنفيذ استنادًا إلى النتائج والتغذية الراجعة.",
      "contact.kicker":"لنبدأ","contact.title":"هل أنت مستعد للبدء؟ لنصنع حضورًا يليق بعلامتك.","contact.body":"تواصل معنا مباشرة، وسنحوّل فكرتك إلى خطة واضحة وتنفيذ احترافي.","contact.cta":"تواصل عبر واتساب","social.whatsapp":"ابدأ محادثتك معنا مباشرة","social.instagram":"شاهد أعمالنا وآخر المستجدات","social.facebook":"تابع أحدث مشاريع رِواء","footer.copy":"رِواء ستوديو — ما يُروى... يُرى."
    },
    en:{
      "nav.services":"Services","nav.packages":"Packages","nav.clients":"Clients","nav.contact":"Contact","nav.start":"Start a project",
      "hero.eyebrow":"Riwaa Studio","hero.title":"Everything your project needs. One team.","hero.body":"From content and production to advertising, branding, websites and apps.","hero.cta":"Start a project","hero.secondary":"Explore services","hero.note1":"Fast, flexible content","hero.note2":"One visual direction","hero.note3":"Social to web solutions","hero.card1k":"CONTENT","hero.card1v":"Production + Reels","hero.card2k":"DESIGN","hero.card2v":"Brand + Listing","hero.card3k":"GROWTH","hero.card3v":"Ads + Management","hero.card4k":"DIGITAL","hero.card4v":"Web + Apps",
      ...
      "about.kicker":"About us","about.title":"Experience came first. Riwaa began in 2026.","about.body":"Riwaa Studio is a marketing agency launched in 2026, built on more than ten years of experience across the Syrian and UAE markets. We work with precision and professionalism, turning ideas into clear visual presence that creates meaningful impact for brands.","about.slogan":"What is told... is seen.","about.years":"Years of experience","about.markets":"Two-market experience","about.launch":"Riwaa Studio launched",
      "photo.kicker":"Photo session","photo.title":"30 photos in a focused session","photo.body":"30 photos: 15 carefully edited, with the rest delivered RAW.","promo.kicker":"Event coverage","promo.title":"Opening or event promo","promo.body":"Unlimited coverage photos + 15 edited photos + one promotional video.",
      ...
      "contact.kicker":"Let’s start","contact.title":"Ready to start? Let’s build your presence.","contact.body":"Message us directly and we’ll turn your idea into a clear plan and polished execution.","contact.cta":"Chat on WhatsApp","social.whatsapp":"Start a direct conversation","social.instagram":"See our work and daily updates","social.facebook":"Follow Riwaa’s latest projects","footer.copy":"Riwaa Studio — what is told... is seen."
    },
    tr:{
      "nav.services":"Hizmetler","nav.packages":"Paketler","nav.clients":"Müşteriler","nav.contact":"İletişim","nav.start":"Projeyi başlat",
      "hero.eyebrow":"Riwaa Studio","hero.title":"Projenizin ihtiyacı olan her şey. Tek ekip.","hero.body":"İçerik ve çekimden reklama, markalaşmaya, web sitelerine ve uygulamalara kadar.","hero.cta":"Projeyi başlat","hero.secondary":"Hizmetleri keşfet","hero.note1":"Hızlı ve esnek içerik","hero.note2":"Tek görsel yön","hero.note3":"Sosyal medyadan web’e çözümler","hero.card1k":"CONTENT","hero.card1v":"Çekim + Reels","hero.card2k":"DESIGN","hero.card2v":"Marka + Listing","hero.card3k":"GROWTH","hero.card3v":"Reklam + Yönetim","hero.card4k":"DIGITAL","hero.card4v":"Web + Uygulama",
      ...
      "about.kicker":"Hakkımızda","about.title":"İsimden önce deneyim vardı. Rewaa 2026'da başladı.","about.body":"Riwaa Studio, 2026 yılında kurulan ve Suriye ile BAE pazarlarında on yılı aşkın deneyime dayanan bir pazarlama ajansıdır. Fikirleri markalar için güçlü ve etkili bir görsel varlığa dönüştürürken hassasiyet ve profesyonellikle çalışıyoruz.","about.slogan":"Anlatılan... görünür olur.","about.years":"Yıllık deneyim","about.markets":"İki pazarda deneyim","about.launch":"Riwaa Studio'nun başlangıcı",
      "photo.kicker":"Fotoğraf çekimi","photo.title":"Odaklı bir seansta 30 fotoğraf","photo.body":"30 fotoğraf: 15'i özenle düzenlenir, kalanlar RAW olarak teslim edilir.","promo.kicker":"Etkinlik çekimi","promo.title":"Açılış veya etkinlik promosu","promo.body":"Sınırsız çekim fotoğrafı + 15 düzenlenmiş fotoğraf + bir promo video.",
      ...
      "contact.kicker":"Başlayalım","contact.title":"Başlamaya hazır mısınız? Görünürlüğünüzü birlikte kuralım.","contact.body":"Bize doğrudan yazın; fikrinizi net bir plana ve profesyonel uygulamaya dönüştürelim.","contact.cta":"WhatsApp'tan yazın","social.whatsapp":"Doğrudan konuşmayı başlatın","social.instagram":"İşlerimizi ve günlük paylaşımlarımızı görün","social.facebook":"Riwaa’nın son projelerini takip edin","footer.copy":"Riwaa Studio — anlatılan... görünür olur."
    }
  };
  ...
  function renderClients(rows){
    ...
    rows.forEach(function(c){
      ...
      if(src){
        ...
        var img=document.createElement("img");img.src=src;img.alt=(c.name||"")+" logo";logo.appendChild(img);
      ...
      meta.appendChild(b);
      if(link){var small=document.createElement("span");small.textContent=tr("clients.visit");meta.appendChild(small);}
      a.appendChild(logo);a.appendChild(meta);grid.appendChild(a);
    });
  }
