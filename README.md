...
Studio Ledger is a bilingual PWA for clients, invoices, team pay, costs and appointments. The browser app uses Supabase for authentication, Row Level Security and realtime sync.
