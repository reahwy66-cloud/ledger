(function(){
  ...
  var I18N={
    ar:{
      ...
      "hero.eyebrow":"استوديو إبداعي متكامل","hero.title":"نصنع حضورًا يُرى، يُحفظ، ويكبر.","hero.body":"من الفكرة إلى التصوير والمونتاج والتصميم والحملات، نبني حضور علامتك كمنظومة واحدة بدل خدمات متفرقة.","hero.cta":"شاهد الباقات","hero.secondary":"استكشف الخدمات","hero.note1":"محتوى سريع ومرن","hero.note2":"تنفيذ بصري موحّد","hero.note3":"حلول من السوشال إلى الويب","hero.card1k":"CONTENT","hero.card1v":"تصوير + Reels","hero.card2k":"DESIGN","hero.card2v":"هوية + Listing","hero.card3k":"GROWTH","hero.card3v":"إعلانات + إدارة","hero.card4k":"DIGITAL","hero.card4v":"مواقع + تطبيقات",
    ...
    en:{
      ...
      "hero.eyebrow":"Full-service creative studio","hero.title":"We build a presence people notice, remember and grow with.","hero.body":"From idea to production, editing, design and campaigns, we build your brand as one connected system instead of scattered services.","hero.cta":"View packages","hero.secondary":"Explore services","hero.note1":"Fast, flexible content","hero.note2":"One visual direction","hero.note3":"Social to web solutions","hero.card1k":"CONTENT","hero.card1v":"Production + Reels","hero.card2k":"DESIGN","hero.card2v":"Brand + Listing","hero.card3k":"GROWTH","hero.card3v":"Ads + Management","hero.card4k":"DIGITAL","hero.card4v":"Web + Apps",
    ...
    tr:{
      ...
      "hero.eyebrow":"Tam kapsamlı yaratıcı stüdyo","hero.title":"Görülen, hatırlanan ve büyüyen bir marka varlığı kuruyoruz.","hero.body":"Fikirden çekime, kurguya, tasarıma ve kampanyalara kadar markanızı ayrı hizmetler yerine tek bir sistem olarak geliştiriyoruz.","hero.cta":"Paketleri gör","hero.secondary":"Hizmetleri keşfet","hero.note1":"Hızlı ve esnek içerik","hero.note2":"Tek görsel yön","hero.note3":"Sosyal medyadan web’e çözümler","hero.card1k":"CONTENT","hero.card1v":"Çekim + Reels","hero.card2k":"DESIGN","hero.card2v":"Marka + Listing","hero.card3k":"GROWTH","hero.card3v":"Reklam + Yönetim","hero.card4k":"DIGITAL","hero.card4v":"Web + Uygulama",
