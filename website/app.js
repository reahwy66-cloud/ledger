(function(){
  ...
  var I18N={
    ar:{
      ...
      "contact.kicker":"خلّينا نبدأ","contact.title":"عندك مشروع؟ أعطينا الفكرة والباقي علينا.","contact.body":"احكي معنا مباشرة على واتساب، ومنحوّل احتياجك لخطة تنفيذ واضحة.","contact.cta":"تواصل عبر واتساب","footer.copy":"رِواء ستوديو — ما يُروى... يُرى."
    },
    en:{
      ...
      "contact.kicker":"Let’s start","contact.title":"Have a project? Give us the idea and we’ll shape the execution.","contact.body":"Message us directly on WhatsApp and we’ll turn your need into a clear execution plan.","contact.cta":"Chat on WhatsApp","footer.copy":"Rewaa Studio — what is told... is seen."
    },
    tr:{
      ...
      "contact.kicker":"Başlayalım","contact.title":"Bir projeniz mi var? Fikri paylaşın, uygulamayı birlikte şekillendirelim.","contact.body":"WhatsApp üzerinden doğrudan bize yazın; ihtiyacınızı net bir uygulama planına dönüştürelim.","contact.cta":"WhatsApp'tan yazın","footer.copy":"Rewaa Studio — anlatılan... görünür olur."
    }
  };
